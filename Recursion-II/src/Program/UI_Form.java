...
public class UI_Form extends javax.swing.JFrame {
  ...
  private ValidatorRename renameValidator;
   ...
   private void turnOffLoaderIcon(JButton jComp)
   {
       jComp.setIcon(null);
   }
    ...
    private void initComponents() {
        ...
        pnlFileRename.add(btnRenameFolderBrowse, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 80, -1, 25));
        ...
        txtRenameTemplate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtRenameTemplateActionPerformed(evt);
            }
        });
        ...
        pnlFileRename.add(spinStartAt, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 150, 53, 26));

        lblRenameTemplateExplain1.setText("Start At:");
        pnlFileRename.add(lblRenameTemplateExplain1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 150, 51, 26));
        ...
        pnlFileRename.add(txtRenameSaveToFolder, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 210, 360, 20));
        ...
        pnlFileRename.add(btnRenameSaveToBrowse, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 210, 90, 20));
        ...
        pnlFileRename.add(pnlRenameRads, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 192, 390, 60));
        ...
        pnlFileRename.add(lblSubsExplain, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 260, 450, 30));
        ...
        pnlRenameIncludeSubLayout.setHorizontalGroup(
            ...
            .addGroup(pnlRenameIncludeSubLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(radRenameIncludeSubs, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlFileRename.add(pnlRenameIncludeSub, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 360, 60));
   ...
   private void renameFiles()
   {
       ...
       String sDir = txtRenameFolder.getText();
       String sTemplate = txtRenameTemplate.getText();
       String copyFolder = "";
       
       if (renameCopy)
           copyFolder = txtRenameSaveToFolder.getText();
       
       int startCounter = Integer.parseInt(spinStartAt.getValue().toString());
       File dir = new File(sDir);
       
       finder = new FileFinder(dir, "*.*", "", Configs.COLUMN_DELIMETER);
       finder.execute();
       renamer = new FileRenamer(dir, sTemplate, startCounter, copyFolder, renameCopy, finder, excludeSubs);
...
//        searchValidator.validateSaveToFile(needSave);      
        ...
        setLoaderIcon(lblRenameStatus);
        renameFilesCreateFileFinder();
        
        lblRenameStatus.setIcon(null);
        
        lblRenameStatus.setText("<html>"
                                + finder.getInnerFileCount() + " files were found in the folder. <br>"
                                + finder.getNestedFileCount() + " files were found in the sub folders. <br>"
                                + finder.getSubFolderCount() + " sub-folders were found." + "</html>");
        
        AuxValidatorForm.styleNormal(txtRenameFolder);
        searchValidator.hideError();
    }//GEN-LAST:event_btnRenameFolderBrowseActionPerformed

    
    private void renameFilesCreateFileFinder()
    {
        ...
        finder = new FileFinder(fileDir, "*.*", "", Configs.COLUMN_DELIMETER);
        finder.execute();
    }
    ...
    private void btnRenameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRenameActionPerformed
        ...
        new Thread(() -> {
                setLoaderIcon(btnRename);
                setLoaderIcon(lblRenameStatus);  
                renameFiles();
                btnRename.setIcon(null);
                lblRenameStatus.setIcon(null);
        }).start();
 ...
 private boolean validateRename()
    {
        renameValidator = new ValidatorRename ( btgRenameOptions,  btgRenameSubs,  txtRenameTemplate,  lblError,  lblRenameStatus,  txtRenameSaveToFolder,  txtRenameFolder,  pnlRenameIncludeSub,  pnlRenameRads,  renameCopy) ;
        return renameValidator.validate();       
    }
    ...
    private void setRenameResultFlag(JRadioButton radButton)
    {
        
        if (radButton.isSelected())
        {
            String sAction = radButton.getActionCommand();
            if (sAction.equalsIgnoreCase("Include subfolders"))
            {
                lblSubsExplain.setVisible(true);
                lblSubsExplain.setText("<html>" + finder.getTotalFileCount() + " files will be renamed."  + "</html>");
                excludeSubs = false;
            }
            else
            {
                lblSubsExplain.setVisible(true);
                lblSubsExplain.setText("<html>" + finder.getInnerFileCount() + " files will be renamed."  + "</html>");
                excludeSubs = true;
            }
        }
    ...
    private void btnRenameSaveToBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRenameSaveToBrowseActionPerformed
        ...
        txtRenameSaveToFolder.setText(fileDir.getAbsolutePath());
    ...
    private void radRenameExcludeSubsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_radRenameExcludeSubsActionPerformed
        setRenameResultFlag((JRadioButton)evt.getSource());
        AuxValidatorForm.styleNormal(pnlRenameIncludeSub);
        validateRename();
    ...
    private void txtRenameTemplateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtRenameTemplateActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtRenameTemplateActionPerformed
